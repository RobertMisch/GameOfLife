        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '100%' }}>
                <div style={{display:'flex'}}>
                    ...
                    <button>Step forward single gen</button>
                ...
                <div>
                    <p>presets</p>
                    <button onClick={() => { if (running) { return } changeSize(-5) }}>random</button>
                    <button onClick={() => { if (running) { return } changeSize(-5) }}>preset 1</button>
                    <button onClick={() => { if (running) { return } changeSize(-5) }}>preset 2</button>
                    <button onClick={() => { if (running) { return } changeSize(-5) }}>preset 3</button>
                </div>
